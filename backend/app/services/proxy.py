"""
PHYNX — ProxyPool : Gestion intelligente des proxies
backend/app/services/proxy.py

Supporte : SOCKS5, HTTP, Tor, Proxies résidentiels
Health-check automatique, ban-detection, rotation intelligente.
"""
import asyncio
import random
import time
